...
public class AdminCategoryController {
    ...
    public ResponseEntity<CategoryResponse> create(@Valid @RequestBody CategoryCreateRequest request) {
        CategoryResponse created = categoryInternalService.create(request);
    ...
    public ResponseEntity<List<CategoryAdminTableResponse>> getAdminTable() {
        return ResponseEntity.ok(categoryInternalService.getAdminTable());
    }
    ...
    public ResponseEntity<CategoryResponse> getById(@PathVariable Long id) {
        return ResponseEntity.ok(categoryInternalService.getById(id));
    }
    ...
    public ResponseEntity<CategoryResponse> update(@PathVariable Long id,
        ...
        return ResponseEntity.ok(categoryInternalService.update(id, request));
    }
    ...
    public ResponseEntity<Void> delete(@PathVariable Long id) {
        categoryInternalService.delete(id);
